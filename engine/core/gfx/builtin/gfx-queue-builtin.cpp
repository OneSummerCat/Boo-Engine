...
void GfxQueueBuiltin::render(std::vector<VkCommandBuffer> &commandBuffers)
{
    ...
    {
        GfxBatchBuiltin *batch = this->_batches[i];
...
void GfxQueueBuiltin::_resetCommandBuffer()
{
    vkResetCommandBuffer(this->_renderTexture->getCommandBuffer(), 0);
}
void GfxQueueBuiltin::_beginCommandBuffer()
{
...
void GfxQueueBuiltin::_beginRenderPass()
{
    GfxRenderPassBuiltin *pass = this->_renderer->getRenderPass();
...
GfxRenderTexture *GfxQueueBuiltin::getRenderTexture()
{
    return this->_renderTexture;
}
void GfxQueueBuiltin::_bindUniformBuffer()
{
...
void GfxQueueBuiltin::_reset()
{
}
void GfxQueueBuiltin::destroy()
{
...
GfxQueueBuiltin::~GfxQueueBuiltin()
{
}
...
// {
//     GfxRenderPass *pass = Gfx::renderer->getPass("scene");
//     if (pass == nullptr)
//     {
