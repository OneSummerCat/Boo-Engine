...
//  * 基础类不包含采样器
//  */
// void GfxBuiltinPipeline::_initDescriptorSetLayout()
// {
//     // 动态 UBO 研究
...
//     {
//         std::cout << "GfxBuiltinPipeline :create descriptor set layout failed " << this->_name << std::endl;
//         return;
//     }
//     std::cout << "GfxBuiltinPipeline :create descriptor set layout success " << this->_name << std::endl;
// }