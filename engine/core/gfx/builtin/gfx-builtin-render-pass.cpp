 ...
 * 保留上一帧的内容
 */
GfxBuiltinRenderPass::GfxBuiltinRenderPass(std::string name) : GfxRenderPass(name)
{
    this->_name = name;
    this->_create();
}
void GfxBuiltinRenderPass::_create()
{
    std::vector<VkAttachmentDescription> attachments;
    attachments.resize(2);
    // 1. 颜色附件
    attachments[0].format = Gfx::_context->getSwapChainImageFormat();
...
GfxBuiltinRenderPass::~GfxBuiltinRenderPass()
{
}
