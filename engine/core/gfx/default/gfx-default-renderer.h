...
private:
	 ...
	 * 渲染管线
	 */
	GfxDefaultPipeline *_pipeline;
	void _initDefaultPipeline();

	GfxDefaultQueue *_queue;
	void _initDefaultRenderQueue();

public:
	GfxDefaultRenderer(std::string name);
	void init();
	GfxDefaultRenderPass *getRenderPass();
	GfxDefaultPipeline *getPipeline();
	std::vector<VkDescriptorSet> getDescriptorSets();

	void createPipeline(std::string name, GfxRendererState pipelineState);
