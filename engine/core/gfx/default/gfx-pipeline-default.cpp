...
GfxPipelineDefault::GfxPipelineDefault(const std::string &name) : GfxPipeline(name)
{
}
...
void GfxPipelineDefault::_initShaderState()
{
 ...
 */
void GfxPipelineDefault::_initVertexInputState()
{
...
void GfxPipelineDefault::_initInputAssemblyState()
{
...
void GfxPipelineDefault::_initMultisampleState()
{
...
void GfxPipelineDefault::_initDepthStencilState()
{
...
void GfxPipelineDefault::_initColorBlendState()
{
...
void GfxPipelineDefault::_initPipelineLayout()
{
...
//  * 基础类不包含采样器
//  */
// void GfxPipelineDefault::_initDescriptorSetLayout()
// {
//     // 动态 UBO 研究
...
//     {
//         std::cout << "GfxPipelineDefault :create descriptor set layout failed " << this->_name << std::endl;
//         return;
//     }
//     std::cout << "GfxPipelineDefault :create descriptor set layout success " << this->_name << std::endl;
// }