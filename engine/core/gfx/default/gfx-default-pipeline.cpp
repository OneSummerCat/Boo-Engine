...
GfxDefaultPipeline::GfxDefaultPipeline(const std::string &name) : GfxPipeline(name)
{
}

void GfxDefaultPipeline::_createPipeline()
{
    GfxPipeline::_createPipeline();
}

void GfxDefaultPipeline::_initShaderState()
{
 ...
 */
void GfxDefaultPipeline::_initVertexInputState()
{
...
void GfxDefaultPipeline::_initInputAssemblyState()
{
    GfxPipeline::_initInputAssemblyState();
}
void GfxDefaultPipeline::_initDynamicState()
{
    GfxPipeline::_initDynamicState();
}
void GfxDefaultPipeline::_initViewportState()
{
    this->_viewport = {};
...
void GfxDefaultPipeline::_initRasterizationState()
{
    GfxPipeline::_initRasterizationState();
}

void GfxDefaultPipeline::_initMultisampleState()
{
...
void GfxDefaultPipeline::_initDepthStencilState()
{
...
void GfxDefaultPipeline::_initPipelineLayout()
{
    ...
    {
        LOGI("[Gfx : PipelineDefault]:: create pipeline layout failed %s", this->_name.c_str());
        return;
    }
}
void GfxDefaultPipeline::_initPipeline()
{
    ...
    {
        LOGI("[Gfx : PipelineDefault]:: create pipeline failed :%s", this->_name.c_str());
        return;
    }
    LOGI("[Gfx : PipelineDefault]:: create pipeline success :%s", this->_name.c_str());
}
...
//  * 基础类不包含采样器
//  */
// void GfxDefaultPipeline::_initDescriptorSetLayout()
// {
//     // 动态 UBO 研究
...
//     {
//         std::cout << "GfxDefaultPipeline :create descriptor set layout failed " << this->_name << std::endl;
//         return;
//     }
//     std::cout << "GfxDefaultPipeline :create descriptor set layout success " << this->_name << std::endl;
// }