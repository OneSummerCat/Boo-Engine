...
void GfxDefaultRenderPass::_create()
{
    LOGI("[Gfx : RenderPassDefault] :: _create %s", this->_name.c_str());
    VkAttachmentDescription colorAttachment = {};
    colorAttachment.format = Gfx::_context->getSwapChainImageFormat(); // 颜色缓冲附着(VkImageView)的格式
    colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;                  // 指定采样数，没有使用多重采样，设置为1
    colorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR;              //; // 重要！VK_ATTACHMENT_LOAD_OP_CLEAR
...
GfxDefaultRenderPass::~GfxDefaultRenderPass()
{
    this->_clear();
}
...
// void GfxRenderPass::_createVkRenderPass()
// {
...
// }
// VkFormat GfxRenderPass::getAttachmentFormat(uint32_t attachment)
// {
//     if (attachment == 0)
//     {
...
// }
// VkAttachmentLoadOp GfxRenderPass::getAttachmentLoadOp(GfxPassAttachmentLoadOp loadOp)
// {
...
//     return VK_ATTACHMENT_LOAD_OP_CLEAR;
// }
// VkAttachmentStoreOp GfxRenderPass::getAttachmentStoreOp(GfxPassAttachmentStoreOp storeOp)
// {
...
//  */
// VkImageLayout GfxRenderPass::getAttachmentLayout(GfxPassAttachmentLayout layout)
// {
