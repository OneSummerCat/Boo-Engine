 ...
 * @brief 渲染器分类
 */
enum class GfxRendererCategory
{
    _UI = 0,
    _3D = 1,
};
...
{
    GfxRendererCategory renderer = GfxRendererCategory::_UI;
    std::string vert = "";
    std::string geom = "";
    std::string frag = "";
     ...
     * 剔除模式
     */
    GfxRendererStateCullMode cullMode = GfxRendererStateCullMode::None;
...
const uint8_t GfxTextureDefault[] = {
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
const uint32_t GfxTextureDefaultWidth = 32;
const uint32_t GfxTextureDefaultHeight = 32;
const uint32_t GfxTextureDefaultChannels = 4;
const size_t GfxTextureDefaultSize = sizeof(GfxTextureDefault);