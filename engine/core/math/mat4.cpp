...
namespace Boo
{
    ...
    {
       // 提取左上角3x3旋转部分
        double trace = mat.getM00() + mat.getM11() + mat.getM22();
        if (trace > 0) {
            // 情况1：迹大于0，数值稳定
            double s = std::sqrt(trace + 1.0) * 2.0;
            out.setW(0.25 * s);
            out.setX((mat.getM21() - mat.getM12()) / s);
            out.setY((mat.getM02() - mat.getM20()) / s);
            out.setZ((mat.getM10() - mat.getM01()) / s);
        } 
        else if (mat.getM00() > mat.getM11() && mat.getM00() > mat.getM22()) {
            // 情况2：m[0][0]最大
            double s = std::sqrt(1.0 + mat.getM00() - mat.getM11() - mat.getM22()) * 2.0;
            out.setW((mat.getM21() - mat.getM12()) / s);
            out.setX(0.25 * s);
            out.setY((mat.getM01() + mat.getM10()) / s);
            out.setZ((mat.getM02() + mat.getM20()) / s);
        } 
        else if (mat.getM11() > mat.getM22()) {
            // 情况3：m[1][1]最大
            double s = std::sqrt(1.0 + mat.getM11() - mat.getM00() - mat.getM22()) * 2.0;
            out.setW((mat.getM02() - mat.getM20()) / s);
            out.setX((mat.getM01() + mat.getM10()) / s);
            out.setY(0.25 * s);
            out.setZ((mat.getM12() + mat.getM21()) / s);
        } 
        else {
            // 情况4：m[2][2]最大
            double s = std::sqrt(1.0 + mat.getM22() - mat.getM00() - mat.getM11()) * 2.0;
            out.setW((mat.getM10() - mat.getM01()) / s);    
            out.setX((mat.getM02() + mat.getM20()) / s);
            out.setY((mat.getM12() + mat.getM21()) / s);
            out.setZ(0.25 * s);
        }
    }
